...
export const canUserSubmit = (contest: Contest, userPhotosCount: number): boolean =>
...
export const canEditPhoto = (photo: Photo, contest: Contest, userId: string): boolean =>
  getContestStatus(contest) === "submission" && photo.authorId === userId;

/** Idem suppression : auteur + phase soumission. */
export const canDeletePhoto = (photo: Photo, contest: Contest, userId: string): boolean =>
