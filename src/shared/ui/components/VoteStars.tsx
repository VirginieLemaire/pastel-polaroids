import { useVotes } from "@/features/votes";
import type { Rating } from "@/features/votes";
...
export default function VoteStars({ photoId, contestId }: VoteStarsProps) {
  ...
  const currentVote = currentUser ? getVoteByUser(photoId, currentUser.id) : undefined;
...
// Hook local pour éviter une dépendance circulaire si user pas dispo.
