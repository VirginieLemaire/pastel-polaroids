...
const PolaroidCard = ({
  ...
  return (
    <div
      className={cn(
        "polaroid w-64 h-80 cursor-pointer select-none",
        flipped && "flipped",
        className
      )}
    ...
    >
      <div className="polaroid-inner">
        ...
        <div className="polaroid-front bg-card brutal-border brutal-shadow p-3 pb-12 flex flex-col">
          ...
          <p className="mt-3 text-center font-mono text-sm text-foreground truncate">
            {title}
          </p>
        </div>
        ...
        <div className="polaroid-back bg-pastel-butter brutal-border brutal-shadow p-5 flex flex-col justify-between">
          <div>
            <h3 className="font-mono text-lg font-bold text-foreground mb-2 border-b-2 border-foreground pb-2">
              {title}
            </h3>
